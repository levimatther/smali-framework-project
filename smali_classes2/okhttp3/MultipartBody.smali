...
.method private writeOrCountBytes(Lokio/BufferedSink;Z)J
    ...
    invoke-interface {v0, v8}, Lokio/BufferedSink;->write([B)Lokio/BufferedSink;

    .line 10
    iget-object v8, p0, Lokhttp3/MultipartBody;->boundary:Lokio/ByteString;

    invoke-interface {v0, v8}, Lokio/BufferedSink;->write(Lokio/ByteString;)Lokio/BufferedSink;
    ...
    invoke-interface {v0, v10}, Lokio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    .line 31
    invoke-interface {v0, v9}, Lokio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v0, v9}, Lokio/BufferedSink;->write([B)Lokio/BufferedSink;
