...
.method private changeColorSelectedText(I)V
    ...
    const-string v0, "---changeColor: Size of the span is zero"
...
.method private changeSizeSelectedText(I)V
    ...
    const-string v0, "---changeSize: Size of the span is zero"
...
.method private clearStyles()V
    ...
    invoke-static {v0}, Lcom/android/ex/editstyledtext/EditStyledText;->access$600(Lcom/android/ex/editstyledtext/EditStyledText;)Landroid/graphics/drawable/Drawable;
...
.method private findLineEnd(Landroid/text/Editable;I)I
    ...
    const-string p2, "EditStyledText.EditorManager"
...
.method private insertHorizontalLine()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/ex/editstyledtext/EditStyledText;->setSelection(I)V
...
.method private insertImageSpan(Landroid/text/style/DynamicDrawableSpan;I)V
    ...
    :cond_0
    const-string p1, "--- insertImageSpan: null span was inserted"
    ...
    invoke-static {p1, p2}, Lcom/android/ex/editstyledtext/EditStyledText;->access$900(Lcom/android/ex/editstyledtext/EditStyledText;I)V
...
.method private isClipBoardChanged(Ljava/lang/CharSequence;)Z
    ...
    const-string v1, "--- isClipBoardChanged:"
...
.method private setSelection()V
    ...
    invoke-virtual {v3, v0, v1}, Lcom/android/ex/editstyledtext/EditStyledText;->setSelection(II)V
    ...
    invoke-virtual {v3, v1, v0}, Lcom/android/ex/editstyledtext/EditStyledText;->setSelection(II)V
    ...
    const-string v3, "Select is on, but cursor positions are illigal.:"
...
.method private setStyledTextSpan(Ljava/lang/Object;II)V
    ...
    const-string v1, "--- setStyledTextSpan:"
...
.method public setEndPos(I)V
    ...
    const-string v1, "--- setSelectedEndPos:"
...
.method public setTextComposingMask(II)V
    ...
    const-string v1, "--- setTextComposingMask:"
...
.method public updateSpanNextToCursor(Landroid/text/Editable;III)V
    ...
    const-string/jumbo v6, "updateSpanNext:"
    ...
    invoke-interface {v1, v2, v2, v9}, Landroid/text/Editable;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;
    ...
    instance-of v13, v11, Landroid/text/style/AlignmentSpan;
    ...
    .line 1402
    iget-object v11, v0, Lcom/android/ex/editstyledtext/EditStyledText$EditorManager;->mEST:Lcom/android/ex/editstyledtext/EditStyledText;

    invoke-virtual {v11}, Lcom/android/ex/editstyledtext/EditStyledText;->getText()Landroid/text/Editable;
    ...
    invoke-interface {v11, v5, v12}, Landroid/text/Editable;->insert(ILjava/lang/CharSequence;)Landroid/text/Editable;

    .line 1404
    iget-object v11, v0, Lcom/android/ex/editstyledtext/EditStyledText$EditorManager;->mEST:Lcom/android/ex/editstyledtext/EditStyledText;

    invoke-virtual {v11, v5}, Lcom/android/ex/editstyledtext/EditStyledText;->setSelection(I)V
    ...
    .line 1390
    instance-of v2, v11, Landroid/text/style/AlignmentSpan;
    ...
    :cond_4
    :goto_2
    iget-object v2, v0, Lcom/android/ex/editstyledtext/EditStyledText$EditorManager;->mEST:Lcom/android/ex/editstyledtext/EditStyledText;

    invoke-virtual {v2}, Lcom/android/ex/editstyledtext/EditStyledText;->getText()Landroid/text/Editable;

    move-result-object v2

    invoke-direct {v0, v2, v8}, Lcom/android/ex/editstyledtext/EditStyledText$EditorManager;->findLineStart(Landroid/text/Editable;I)I
    ...
    .line 1396
    invoke-interface {v1, v11, v8, v14, v2}, Landroid/text/Editable;->setSpan(Ljava/lang/Object;III)V
...
.method public updateSpanPreviousFromCursor(Landroid/text/Editable;III)V
    ...
    const-string/jumbo v1, "updateSpanPrevious:"
    ...
    invoke-interface {p1, v3, v3, v4}, Landroid/text/Editable;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;
    ...
    instance-of v7, v6, Lcom/android/ex/editstyledtext/EditStyledText$EditStyledTextSpans$MarqueeSpan;
    ...
    .line 1353
    :cond_0
    instance-of v7, v6, Lcom/android/ex/editstyledtext/EditStyledText$EditStyledTextSpans$HorizontalLineSpan;
    ...
    .line 1366
    invoke-virtual {v6}, Lcom/android/ex/editstyledtext/EditStyledText;->getText()Landroid/text/Editable;
    ...
    invoke-interface {v6, v0, v7}, Landroid/text/Editable;->insert(ILjava/lang/CharSequence;)Landroid/text/Editable;
    ...
    .line 1338
    instance-of v9, v6, Lcom/android/ex/editstyledtext/EditStyledText$EditStyledTextSpans$MarqueeSpan;

    if-nez v9, :cond_5

    instance-of v9, v6, Landroid/text/style/AlignmentSpan;
    ...
    .line 1342
    :cond_3
    iget-boolean v9, p0, Lcom/android/ex/editstyledtext/EditStyledText$EditorManager;->mKeepNonLineSpan:Z
    ...
    invoke-direct {p0, v9, p2}, Lcom/android/ex/editstyledtext/EditStyledText$EditorManager;->findLineEnd(Landroid/text/Editable;I)I
    ...
    const-string/jumbo v8, "updateSpanPrevious: extend span"
    ...
    .line 1350
    invoke-interface {p1, v6, v7, v9, v8}, Landroid/text/Editable;->setSpan(Ljava/lang/Object;III)V
